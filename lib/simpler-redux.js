...
connectLifeCycleComponentWithStore = _reactSimplerRedux.connectLifeCycleComponentWithStore;
...
//
var stateAccessors = exports.stateAccessors = function stateAccessors(store, reducerKey, defaultState) {
  if (process.env.NODE_ENV !== 'production') {
    if (store === undefined) {
  ...
  if (defaultState !== undefined) {
    ret.reducerState = (0, _proxy2.default)(store, reducerKey, defaultState);
  }
      ...
      } }, { key: 'render', value: function render()
      {
        ...
        return (
          ...
          this.props, {
            ...
            store: this.context.store, __source: { fileName: _jsxFileName, lineNumber: 111 } })));
...
var hookedLifeCycleComponent = function hookedLifeCycleComponent(Component) {var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var
  ...
  return (
    _react2.default.createElement(ReactLifeCycleComponent, {
      ...
      componentToRender: function componentToRender() {return _react2.default.createElement(Component, _extends({}, propsToPass, { __source: { fileName: _jsxFileName, lineNumber: 180 } }));}, __source: { fileName: _jsxFileName, lineNumber: 174 } }));

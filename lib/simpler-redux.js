...
{var
  ...
  options.reduxOptions,storeIsDefinedCallback = options.storeIsDefinedCallback,reducerKey = options.reducerKey,isDynamicReducer = options.isDynamicReducer,initialState = options.initialState,mapStateToProps = options.mapStateToProps,mapDispatchToProps = options.mapDispatchToProps,serviceFunctions = options.serviceFunctions,uiComponent = options.uiComponent,selectors = options.selectors,initialUIState = options.initialUIState,noStoreParameterOnServiceFunctions = options.noStoreParameterOnServiceFunctions,mergeProps = options.mergeProps;
      ...
      } }, { key: 'render', value: function render()
      {
        ...
        return (
          ...
          this.props, {
            ...
            store: this.context.store, __source: { fileName: _jsxFileName, lineNumber: 230 } })));
...
var hookedLifeCycleComponent = function hookedLifeCycleComponent(Component) {var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var
  ...
  return (
    _react2.default.createElement(ReactLifeCycleComponent, {
      ...
      componentWillUnmount: componentWillUnmount,
      componentDidCatch: componentDidCatch,
      componentToRender: function componentToRender() {return _react2.default.createElement(Component, _extends({}, propsToPass, { __source: { fileName: _jsxFileName, lineNumber: 301 } }));}, __source: { fileName: _jsxFileName, lineNumber: 295 } }));

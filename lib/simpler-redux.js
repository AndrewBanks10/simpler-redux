...
options)
{
  ...
  var isDynamicReducer = options.isDynamicReducer;
  var reducerKey = options.reducerKey;
  var initialState = void 0;
  if (isDynamicReducer && options.initialState !== undefined) {
    initialState = _extends({}, options.initialState);
  }
      ...
      } }, { key: 'render', value: function render()
      {
        ...
        return (
          ...
          this.props, {
            ...
            store: this.context.store, __source: { fileName: _jsxFileName, lineNumber: 210 } })));
...
var hookedLifeCycleComponent = function hookedLifeCycleComponent(Component) {var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var
  ...
  return (
    _react2.default.createElement(ReactLifeCycleComponent, {
      ...
      componentWillUnmount: componentWillUnmount,
      componentDidCatch: componentDidCatch,
      componentToRender: function componentToRender() {return _react2.default.createElement(Component, _extends({}, propsToPass, { __source: { fileName: _jsxFileName, lineNumber: 279 } }));}, __source: { fileName: _jsxFileName, lineNumber: 273 } }));

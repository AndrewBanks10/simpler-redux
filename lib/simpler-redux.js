...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {Object.defineProperty(exports, "__esModule", { value: true }); // 22 lines without blanks, comments and argument checks.
var reduxStore = void 0;

var register = function register(store) {return (
    reduxStore = store);};

var setState = function setState(reducerKey, objToMerge, type) {
...
var getState = function getState(reducerKey) {
  if (process.env.NODE_ENV !== 'production') {
    if (typeof reduxStore === 'undefined') {
...
var generalReducer = function generalReducer(reducerKey, initialState) {
  return function () {var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Object.assign({}, initialState);var action = arguments[1];
...
register = register;exports.setState = setState;exports.getState = getState;exports.generalReducer = generalReducer;

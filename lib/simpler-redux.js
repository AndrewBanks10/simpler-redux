...
var simplerReduxOptions = exports.simplerReduxOptions = void 0;
...
{var preloadedState = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  ...
  exports.simplerReduxOptions = simplerReduxOptions = options;
...
{var
  ...
  HOC = function (_React$Component) {_inherits(HOC, _React$Component);
    function HOC(props, context) {_classCallCheck(this, HOC);
      ...
      var _this = _possibleConstructorReturn(this, (HOC.__proto__ || Object.getPrototypeOf(HOC)).call(this, props, context));if (isDynamicReducer || _simplerRedux.simplerReduxOptions.isDynamicReducer) {
      ...
      } }, { key: 'render', value: function render()
      {
        ...
        return (
          ...
          this.props, {
            ...
            store: this.context.store, __source: { fileName: _jsxFileName, lineNumber: 275 } })));
...
var hookedLifeCycleComponent = function hookedLifeCycleComponent(Component) {var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var
  ...
  return (
    _react2.default.createElement(ReactLifeCycleComponent, {
      ...
      componentWillUnmount: componentWillUnmount,
      componentDidCatch: componentDidCatch,
      componentToRender: function componentToRender() {return _react2.default.createElement(Component, _extends({}, propsToPass, { __source: { fileName: _jsxFileName, lineNumber: 346 } }));}, __source: { fileName: _jsxFileName, lineNumber: 340 } }));

...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.buildSelectorsFromUIState = exports.connectLifeCycleComponentWithStore = exports.connectWithStore = exports.allServiceFunctionsToProps = exports.allStateToProps = exports.registerSimplerRedux = exports.generalReducer = exports.getStateFunction = exports.setStateFunction = exports.stateAccessors = exports.makeSharedModuleKeyName = undefined;var _simplerRedux = __webpack_require__(5);
...
var _reactSimplerRedux = __webpack_require__(8);exports.
...
makeSharedModuleKeyName = _simplerRedux.makeSharedModuleKeyName;exports.
stateAccessors = _simplerRedux.stateAccessors;exports.
setStateFunction = _simplerRedux.setStateFunction;exports.
getStateFunction = _simplerRedux.getStateFunction;exports.
generalReducer = _simplerRedux.generalReducer;exports.
registerSimplerRedux = _simplerRedux.registerSimplerRedux;exports.
allStateToProps = _reactSimplerRedux.allStateToProps;exports.
allServiceFunctionsToProps = _reactSimplerRedux.allServiceFunctionsToProps;exports.
connectWithStore = _reactSimplerRedux.connectWithStore;exports.
connectLifeCycleComponentWithStore = _reactSimplerRedux.connectLifeCycleComponentWithStore;exports.
buildSelectorsFromUIState = _simplerRedux.buildSelectorsFromUIState;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module, process) {Object.defineProperty(exports, "__esModule", { value: true });exports.buildSelectorsFromUIState = exports.makeSharedModuleKeyName = exports.stateAccessors = exports.setStateFunction = exports.getStateFunction = exports.generalReducer = exports.registerSimplerRedux = undefined;var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
      ...
      } }, { key: 'render', value: function render()
      {
        ...
        return (
          ...
          this.props, {
            ...
            store: this.context.store, __source: { fileName: _jsxFileName, lineNumber: 116 } })));
...
var hookedLifeCycleComponent = function hookedLifeCycleComponent(Component) {var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var
  ...
  return (
    _react2.default.createElement(ReactLifeCycleComponent, {
      ...
      componentToRender: function componentToRender() {return _react2.default.createElement(Component, _extends({}, propsToPass, { __source: { fileName: _jsxFileName, lineNumber: 185 } }));}, __source: { fileName: _jsxFileName, lineNumber: 179 } }));
